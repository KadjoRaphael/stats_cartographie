...
Ce cours a pour objectif d'initier les étudiant·es à la **statistique appliquée
à l'analyse de données géographiques**, à travers une série de travaux dirigés
(TD) portant sur des cas concrets : immigration, santé, mobilité sociale,
...
**Magrit** sera utilisé pour la réalisation des cartes thématiques.
